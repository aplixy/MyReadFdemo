...
public class TaskListFragment extends Fragment {
    ...
    private static class WeakRunnable implements Runnable {
        ...
        WeakReference<TaskListFragment> mMainFragmentReference;

        public WeakRunnable(TaskListFragment mainFragment) {
            this.mMainFragmentReference = new WeakReference<TaskListFragment>(mainFragment);
        }

        @Override
        public void run() {
            TaskListFragment mainFragment = mMainFragmentReference.get();
