...
public class MainNoteBookFragment extends Fragment {
    ...
    public static final String TAG = MainNoteBookFragment.class.getSimpleName();
    ...
    public static Fragment newInstance() {
        MainNoteBookFragment fragment = new MainNoteBookFragment();
    ...
    private static class WeakRunnable implements Runnable {
        ...
        WeakReference<MainNoteBookFragment> mMainFragmentReference;

        public WeakRunnable(MainNoteBookFragment mainFragment) {
            this.mMainFragmentReference = new WeakReference<MainNoteBookFragment>(mainFragment);
        }

        @Override
        public void run() {
            MainNoteBookFragment mainFragment = mMainFragmentReference.get();
