...
import com.example.myreadfdemo.ui.adapter.ShareFragNaviAdapter;
...
public class MainShareFragment extends Fragment {
    ...
    public static final String TAG = MainShareFragment.class.getSimpleName();
	...
	public static Fragment newInstance() {
		Fragment fragment = new MainShareFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mNavigator = new FragmentNavigator(getChildFragmentManager(), new ShareFragNaviAdapter(), R.id.childContainer);
